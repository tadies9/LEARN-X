...
import { useTheme, useThemeColors } from '@/components/providers/enhanced-theme-provider';
import { 
  Monitor, 
  Sun, 
  Moon, 
    ...
    <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-3 p-4 rounded-lg border transition-colors hover:bg-accent/50">
                    ...
                    <div className="flex-1 space-y-2">
                      ...
                      >
                        ...
                        <Badge 
                          variant="outline" 
                          className={cn("text-xs", option.badgeColor)}
                        >
                          {option.badge}
                        </Badge>
                      </Label>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Real-time information about your active theme
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                <span className="font-mono text-sm">
                  {getThemeDisplayName(preference)}
                </span>
                {isSystemTheme && (
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
              {Object.entries(colors.statusColors).map(([status, colorClass]) => (
                <div key={status} className={cn("p-2 rounded text-xs text-center", colorClass)}>
                  {status.replace('-', ' ')}
                </div>
              ))}
            </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Export your theme preferences and additional options
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
