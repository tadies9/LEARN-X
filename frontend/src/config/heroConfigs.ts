...
export const heroConfigs: Record<string, HeroContent> = {
  main: {
    ...
    subheading:
      'Upload your class materials once—our AI turns them into bite-sized lessons, examples, and quizzes built around your interests, pace, and goals.',
    primaryCTA: {
  ...
  tesla: {
    headline:
      'Turn any PDF into<br className="hidden lg:block" /><span className="lg:hidden"> </span>your personal AI tutor',
  ...
  standard: {
    ...
    headline:
      'Turn every class into a <span className="bg-gradient-to-r from-primary to-blue-400 bg-clip-text text-transparent">personal AI tutor</span>',
    subheading:
      'Upload any syllabus or lecture deck—students get chat-style help, professors get insight dashboards.',
    primaryCTA: {
