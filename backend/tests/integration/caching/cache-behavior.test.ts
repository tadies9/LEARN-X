...
describe('Caching Integration Tests', () => {
  ...
  describe('AI Content Caching', () => {
    test('should cache AI-generated content', async () => {
      ...
      const firstResponse = await fetch(`${testConfig.api.baseUrl}/api/v1/ai/generate-content`, {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${authToken}`,
          'Content-Type': 'application/json',
      ...
      const cachedResponse = await fetch(`${testConfig.api.baseUrl}/api/v1/ai/generate-content`, {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${authToken}`,
          'Content-Type': 'application/json',
  ...
  describe('Search Results Caching', () => {
    test('should cache search results', async () => {
      ...
      const firstResponse = await fetch(`${testConfig.api.baseUrl}/api/v1/search`, {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${authToken}`,
          'Content-Type': 'application/json',
      ...
      const cachedResponse = await fetch(`${testConfig.api.baseUrl}/api/v1/search`, {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${authToken}`,
          'Content-Type': 'application/json',
      ...
      const report = tracker.getReport();
      expect(report['cached-search'].duration).toBeLessThan(report['first-search'].duration * 0.2);
    });
  ...
  describe('Dashboard Data Caching', () => {
    test('should cache dashboard statistics', async () => {
      ...
      const firstResponse = await fetch(`${testConfig.api.baseUrl}/api/v1/dashboard/stats`, {
      ...
      const cachedResponse = await fetch(`${testConfig.api.baseUrl}/api/v1/dashboard/stats`, {
        headers: { Authorization: `Bearer ${authToken}` },
      });
    ...
    test('should invalidate dashboard cache on data change', async () => {
      // Get initial stats
      const initialResponse = await fetch(`${testConfig.api.baseUrl}/api/v1/dashboard/stats`, {
        headers: { Authorization: `Bearer ${authToken}` },
      });
      ...
      // Get stats again
      const afterCreateResponse = await fetch(`${testConfig.api.baseUrl}/api/v1/dashboard/stats`, {
        headers: { Authorization: `Bearer ${authToken}` },
      });
  ...
  describe('Cache Expiration', () => {
    test('should respect TTL settings', async () => {
      ...
      const response = await fetch(`${testConfig.api.baseUrl}/api/v1/ai/generate-content`, {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${authToken}`,
          'Content-Type': 'application/json',
      ...
      const expiredResponse = await fetch(`${testConfig.api.baseUrl}/api/v1/ai/generate-content`, {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${authToken}`,
          'Content-Type': 'application/json',
  ...
  describe('Cache Warming', () => {
    test('should support cache warming for popular content', async () => {
      ...
      const warmResponse = await fetch(`${testConfig.api.baseUrl}/api/v1/admin/cache/warm`, {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${authToken}`,
          'Content-Type': 'application/json',
  ...
  describe('Cache Statistics', () => {
    test('should track cache hit/miss rates', async () => {
      ...
      const statsResponse = await fetch(`${testConfig.api.baseUrl}/api/v1/admin/cache/stats`, {
        headers: { Authorization: `Bearer ${authToken}` },
      });
